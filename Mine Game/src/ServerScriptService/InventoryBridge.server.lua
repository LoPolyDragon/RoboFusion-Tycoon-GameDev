...
if not RF then RF = Instance.new("Folder", RS) RF.Name = "RemoteFunctions" end
local RE = RS:FindFirstChild("RemoteEvents")
if not RE then RE = Instance.new("Folder", RS) RE.Name = "RemoteEvents"  end
...
function GameLogic._emitInventory(plr)
	...
	-- 触发附加监听
	for _,cb in ipairs(listeners) do cb(plr) end
end
