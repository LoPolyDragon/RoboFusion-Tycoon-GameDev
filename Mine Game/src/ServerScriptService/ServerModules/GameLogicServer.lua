...
local PlayerData = require(game.ServerScriptService:WaitForChild("PlayerDataService"))
...
function GL.GetInventory(plr)
	local info = PlayerData[plr.UserId]
	return (info and info.Inventory) or {}
end

GL.GetInventoryData = GL.GetInventory
